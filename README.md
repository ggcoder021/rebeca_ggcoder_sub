...
برای تغییر نام سازنده، عبارت زیر را در مسیر نصب با دستور nano فایل را باز و با CNTR+W جستجو کنید:
...
> **نکته:** برای استفاده از مسیر `releases/latest/download/index.html` باید ابتدا دسترسی روت داشته باشید
